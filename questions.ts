...
export const Questions = [
  ...
  ['brings the customer\'s perspective into discussions', 'Strategic Thinking', 1],
  ['Asks for details to understand the impact during refinement', 'Strategic Thinking', 1],
